...
describe 'manifest generator' do
  ...
  context 'with no arguments' do
    it 'should exit with a non-zero status' do
      stdout, _, status = stubbed_env.execute("scripts/generate-deployment-manifest")
  ...
  context 'with a bosh-lite' do
    ...
    it 'should generate manifest' do
      stdout, _, _ = stubbed_env.execute("scripts/generate-deployment-manifest #{infrastructure}")
